...
*/
function(t,i){t.fp_scrolloverflow=function(){t.IScroll||(t.IScroll=module.exports);var s="fp-scrollable",e="."+s,o=".fp-section",n=o+".active",r=".fp-tableCell";function h(){var s=this;function e(){fp_utils.hasClass(i.body,"fp-responsive")?h(l):h(n)}function n(t){if(!fp_utils.hasClass(t,"fp-noscroll")){fp_utils.css(t,{overflow:"hidden"});var i,e,n,h=s.options.scrollOverflowHandler,l=h.wrapContent(),c=fp_utils.closest(t,o),p=h.scrollable(t),d=(e=c,null!=(n=fp_utils.closest(e,o))?parseInt(getComputedStyle(n)["padding-bottom"])+parseInt(getComputedStyle(n)["padding-top"]):0);null!=p?i=h.scrollHeight(t):(i=t.scrollHeight,s.options.verticalCentered&&(i=a(r,t)[0].scrollHeight));var u=fp_utils.getWindowHeight(),f=u-d;u<i+d?null!=p?h.update(t,f):(s.options.verticalCentered?(fp_utils.wrapInner(a(r,t)[0],l.scroller),fp_utils.wrapInner(a(r,t)[0],l.scrollable)):(fp_utils.wrapInner(t,l.scroller),fp_utils.wrapInner(t,l.scrollable)),h.create(t,f,s.iscrollOptions)):h.remove(t),fp_utils.css(t,{overflow:""})}}function h(t){a(o).forEach((function(i){var s=a(".fp-slide",i);s.length?s.forEach((function(i){t(i)})):t(i)}))}function l(t){var i=s.options.scrollOverflowHandler;fp_utils.hasClass(fp_utils.closest(t,o),"fp-auto-height-responsive")&&i.remove(t)}s.options=null,s.init=function(o,n){return s.options=o,s.iscrollOptions=n,"complete"===i.readyState&&(e(),fullpage_api.shared.afterRenderActions()),t.addEventListener("load",(function(){e(),fullpage_api.shared.afterRenderActions()})),s},s.createScrollBarForAll=e,s.createScrollBar=n}IScroll.prototype.wheelOn=function(){this.wrapper.addEventListener("wheel",this),this.wrapper.addEventListener("mousewheel",this),this.wrapper.addEventListener("DOMMouseScroll",this)},IScroll.prototype.wheelOff=function(){this.wrapper.removeEventListener("wheel",this),this.wrapper.removeEventListener("mousewheel",this),this.wrapper.removeEventListener("DOMMouseScroll",this)};var a=null,l=null,c={refreshId:null,iScrollInstances:[],lastScrollY:null,hasBeenInit:!1,iscrollOptions:{scrollbars:!0,mouseWheel:!0,hideScrollbars:!1,fadeScrollbars:!1,disableMouse:!0,interactiveScrollbars:!0},init:function(i){a=fp_utils.$,l=i;var s="ontouchstart"in t||0<navigator.msMaxTouchPoints||navigator.maxTouchPoints;return c.iscrollOptions.click=s,c.hasBeenInit=!0,c.iscrollOptions=fp_utils.deepExtend(c.iscrollOptions,i.scrollOverflowOptions),(new h).init(i,c.iscrollOptions)},toggleWheel:function(t){a(e,a(n)[0]).forEach((function(i){var s=i.fp_iscrollInstance;null!=s&&(t?s.wheelOn():s.wheelOff())}))},setIscroll:function(t,i){if(c.hasBeenInit&&t){var s=fp_utils.closest(t,e)||a(e,t)&&a(e,t)[0],o=i?"enable":"disable";s&&s.fp_iscrollInstance[o]()}},onLeave:function(){c.toggleWheel(!1)},beforeLeave:function(){c.onLeave()},afterLoad:function(){c.toggleWheel(!0)},create:function(t,i,s){a(e,t).forEach((function(e){fp_utils.css(e,{height:i+"px"});var n=e.fp_iscrollInstance;null!=n&&c.iScrollInstances.forEach((function(t){t.destroy()})),n=new IScroll(e,s),c.iScrollInstances.push(n),fp_utils.hasClass(fp_utils.closest(t,o),"active")||n.wheelOff(),e.fp_iscrollInstance=n}))},isScrolled:function(t,i){var s=i.fp_iscrollInstance;if(!s)return!0;if("top"===t)return 0<=s.y&&!fp_utils.getScrollTop(i);if("bottom"===t){var e=c.lastScrollY===s.y;return c.lastScrollY=s.y,(e?1:0)+(0-s.y)+fp_utils.getScrollTop(i)+i.offsetHeight>=i.scrollHeight}},scrollable:function(t){return a(".fp-slides",t).length?a(e,a(".fp-slide.active",t)[0])[0]:a(e,t)[0]},scrollHeight:function(t){return a(".fp-scroller",a(e,t)[0])[0].scrollHeight},remove:function(t){if(null!=t){var i=a(e,t)[0];if(null!=i){var s=i.fp_iscrollInstance;null!=s&&s.destroy(),i.fp_iscrollInstance=null,fp_utils.unwrap(a(".fp-scroller",t)[0]),fp_utils.unwrap(a(e,t)[0])}}},update:function(t,i){clearTimeout(c.refreshId),c.refreshId=setTimeout((function(){c.iScrollInstances.forEach((function(t){t.refresh(),fullpage_api.silentMoveTo(fp_utils.index(a(n)[0])+1)}))}),150),fp_utils.css(a(e,t)[0],{height:i+"px"}),l.verticalCentered&&fp_utils.css(a(e,t)[0].parentNode,{height:i+"px"})},wrapContent:function(){var t=i.createElement("div");t.className=s;var e=i.createElement("div");return e.className="fp-scroller",{scrollable:t,scroller:e}}};return{iscrollHandler:c}}()}(window,document);